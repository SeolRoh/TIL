...
upload 파일형식: 조이름-본인이름-주제keyword
...
a1studentX/a1class123 (X:1~14)
a2studentX/a2class123 (X:1~14)

Asia Pacific (Seoul)ap-northeast-2 : student1,student2,student14
Asia Pacific (Tokyo)ap-northeast-1 : student3,student4
US East (N. Virginia)us-east-1 : student5,student6,student13
...
https://github.com/joneconsulting/cloud-computing/tree/master/04.Docker
```